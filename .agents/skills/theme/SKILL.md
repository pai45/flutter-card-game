...
`profileGradient`, `wagerPlacedGradient`. Clipped cyber panels (`CyberPanel` and similar
surfaces) are **flat** `Cyber.panel` fills, not gradients — see cyber-ui's palette section.
