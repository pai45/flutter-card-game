...
class MockPickRepository implements PickRepository {
  ...
  List<PickMarket> _buildMarkets() => [
    PickMarket(
      id: 'fifa_fra_sen_winner',
      question: 'France vs Senegal result',
      ...
      volumeOz: 4200,
      closesAt: DateTime(2026, 6, 16, 18),
      priceHistory: _history([
        {'fra': 49, 'draw': 27, 'sen': 24},
        {'fra': 51, 'draw': 25, 'sen': 24},
        {'fra': 52, 'draw': 25, 'sen': 23},
      ]),
      contextTitle: 'Group I opener',
    ...
    PickMarket(
      id: 'fifa_arg_alg_winner',
      question: 'Argentina vs Algeria result',
      type: PickMarketType.match,
      sport: Sport.football,
      leagueId: 'fifa',
      leagueLabel: 'FIFA',
      ...
      volumeOz: 5600,
      closesAt: DateTime(2026, 6, 16, 23),
      priceHistory: _history([
        {'arg': 58, 'draw': 24, 'alg': 18},
        {'arg': 60, 'draw': 23, 'alg': 17},
        {'arg': 61, 'draw': 22, 'alg': 17},
      ]),
      contextTitle: 'Defending champions',
      contextSubtitle: 'Winner after 90 minutes',
      homeLabel: 'Argentina',
      awayLabel: 'Algeria',
      resultNote: 'Closes at kickoff',
    ...
    PickMarket(
      id: 'fifa_irq_nor_btts',
      question: 'Iraq vs Norway: both teams to score?',
      ...
      volumeOz: 3100,
      closesAt: DateTime(2026, 6, 16, 20, 30),
      priceHistory: _history([
        {'yes': 44, 'no': 56},
        {'yes': 46, 'no': 54},
        {'yes': 47, 'no': 53},
    ...
    PickMarket(
      id: 'fifa_eng_cro_over_2_5',
      question: 'England vs Croatia over 2.5 goals?',
      type: PickMarketType.event,
      sport: Sport.football,
      leagueId: 'fifa',
      leagueLabel: 'FIFA',
      ...
      volumeOz: 3900,
      closesAt: DateTime(2026, 6, 17, 20, 30),
      priceHistory: _history([
        {'yes': 51, 'no': 49},
        {'yes': 53, 'no': 47},
        {'yes': 55, 'no': 45},
