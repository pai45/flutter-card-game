...
linked-pick surfaces provide context around the quiz.

## Player Flow

1. Browse the selected match day and open an eligible fixture/quiz.
...
affordable/unaffordable/paid, and result-reveal states are represented.
...
- **BUILT:** Multi-sport fixture board, staged quizzes, edits/locking, boosters,
  XP settlement/reveal, histories, activity streak recording, achievements, and
  the paid Scoreline contest exception.
