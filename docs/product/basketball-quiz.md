...
Basketball Quiz is StatOz's trivia ladder mode. It gives the Games tab a knowledge-first loop: choose a category, pay a small Oz Coin entry fee, answer a 10-question set, and earn XP when the set is passed.
...
|----------|-------|-----------------------|
| Easy | Basketball basics | 5 XP |
| Medium | Franchises and playoffs | 10 XP |
| Hard | Deep-cut trivia | 20 XP |
| Global | World basketball | 30 XP |
