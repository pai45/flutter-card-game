...
F1 Quiz is StatOz's trivia ladder mode. It gives the Games tab a knowledge-first loop: choose a category, pay a small Oz Coin entry fee, answer a 10-question set, and earn XP when the set is passed.
...
|----------|-------|-----------------------|
| Easy | F1 basics | 5 XP |
| Medium | Constructors and circuits | 10 XP |
| Hard | Deep-cut trivia | 20 XP |
| Global | World championship history | 30 XP |
