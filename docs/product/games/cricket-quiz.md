...
> **Scope:** Cricket trivia categories, set ladder, answer feedback, entry cost, persistence, and XP
...
- **BUILT:** Cricket content on the shared quiz ladder with a 25-coin entry,
